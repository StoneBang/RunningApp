...
public class CityPicker {
    ...
    public void show(){
        ...
        final CityPickDialogFragment cityPickerFragment =
                CityPickDialogFragment.newInstance(enableAnim);
    ...
    public void locateComplete(LocatedCity location, @LocateState.State int state){
        CityPickDialogFragment fragment = (CityPickDialogFragment) mFragmentManager.findFragmentByTag(TAG);
        if (fragment != null){
